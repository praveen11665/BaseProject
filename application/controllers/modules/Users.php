...
class Users extends MY_Controller 
{
  ...
  public function index($Data=array())
  {
    ...
    {
       $view_data = array(
                            'form_heading'      => $this->lang->line('create_user_form_title'),
                            'form_title'        => $this->lang->line('create_user_form_title'),
                            'form_description'  => $this->lang->line(''),
                            'list_heading'      => $this->lang->line(''),
                            'list_title'        => $this->lang->line(''),
                            'list_description'  => $this->lang->line('create_user_form_description'),
                            'formUrl'           => 'modules/Users/ajaxLoadForm',
                            'list_view'         => TRUE,
                            'buttonview'        => TRUE
                          );
        ...
        $this->table->set_heading('User Name', 'Full Name', 'Email Address', 'Mobile Number', 'Role Name','Status','Created at','Action');

        $view_data['dataTableUrl']   =   'modules/Users/datatable';
        $data = array(
                        'title'     =>  $this->dbvars->app_name.' - '.$this->lang->line('create_user_form_title'),
  ...
  public function ajaxLoadForm($Data = array())
  {
    ...
    {     
      ...
      if($this->input->post('user_id') == "")
      {
        ...
        $validation_rules[] = array(
            'field' => 'username',
            'label' => 'username',
            'rules' => 'trim|required|alpha|max_length[12]|is_unique[' . db_table('user_table') . '.username]',
            'errors' => [
    ...
    if($isFormLoad)
    {
      ...
      {
        $constraint_array   = array('user_id'   =>   $this->input->get('pkey_id'));
        ...
        $Data['ActionUrl']   =  'modules/Users/ajaxLoadForm';
        $this->load->view('modules/users_form', $Data);
    }
  }
  ...
  public function privilage($user_id='')
  {
    if( $this->acl_permits('setting.users_privilage'))
    {
      ...
      $viewData['actionUrl']        = 'modules/Users/formPrivilegeSubmit';
      ...
      $data = array (
                    ...
                    'content'   =>  $this->load->view('modules/privilege_roles_form', $viewData, TRUE)
                    );
      //Load Base templete
      $this->load->view($this->dbvars->app_template, $data);
    }  
  ...
  public function profileSubmit($Data = array())
  {
    ...
    {      
      ...
      if($this->input->post('user_id') == "" || $this->input->post('passwd') != "")
      { 
        $this->form_validation->set_rules('passwd', 'Password', 'required|callback_is_password_strong');
        $this->form_validation->set_rules('confirm_password', 'confirm Password', 'trim|required|matches[passwd]'); 
      ...
      $this->form_validation->set_rules('address_line_2', 'Address Line 2', 'trim|required');
