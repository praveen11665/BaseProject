                        ...
                        <div class="card-box p-5">
                            <h2 class="text-uppercase text-center pb-4">
                               <!-- <a href="<?php echo base_url(); ?>" class="text-dark">
                                    ...
                                    <span class="manufacturing"><?php echo $this->dbvars->app_name;?> <sup class="beta">Beta</sup></span>
                                </a>
                                <a href="<?php echo base_url(); ?>" class="manufacturing"><?php echo $this->dbvars->app_name;?> </a>-->
                                <img src="<?php echo base_url('global/assets/images/logo.png'); ?>">
                            </h2>
<?php
...
?>
                ...
                <div class="form-group">
                    ...
                    <input value="admin" maxlength="255" name="login_string" id="login_string" autocomplete="off" class="form-control" placeholder="<?php echo $this->lang->line('username_placeholder'); ?>" type="text" autofocus>
...
<!-- Begin page -->
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright"><?php echo date('Y'); ?> &copy; Project Name. All rights reserved.</p>
            </div>
